...
class _HiveTodoState extends State<HiveTodo> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        children: [
                          IconButton(onPressed: () => showAlertbox(task[index]['id']),
  ...
  Future<void> createTask(Map<String, dynamic> mytask) async {
    ///replaced map with my task and string with dynamic
  ...
  void readTask_refreshUi() {
    final task_from_hive = my_box.keys.map((key) {
      ...
      ///single map corresponding to the key
      return {
        'id': key,
        'taskname': value['tname'],

        ///tname is key from hive
